...
export default function ClassSelectionScreen({ userId, onCreated }: ClassSelectionScreenProps) {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-black/90 z-50 relative">
            <div className="max-w-4xl w-full medieval-border p-8 bg-black/80">
